<template>
    <!-- <v-layout> -->
    <!-- <v-main class="ma-6"> -->
    <h1 class="text-h3 mb-6">Create Love Poem</h1>

    <v-form @submit.prevent="submit">
        <!-- <v-container> -->
        <v-row>
            <v-col cols="12" md="8" xl="4">
                <v-text-field v-model="nameOfLovedOne" label="Name of loved one" required hide-details
        ...
        <v-row>
            <v-col cols="12" md="8" xl="4">
                <v-btn color="primary" type="submit">generate poem</v-btn>
            </v-col>
        </v-row>
        <br /><br />
